...
namespace Maths
{
	...
	template<typename T>
	const Vector2<T> Vector2<T>::One(0.2, 0.2);

	template<typename T>
	const Vector2<T> Vector2<T>::UnitX(0.2, 0);

	template<typename T>
	const Vector2<T> Vector2<T>::UnitY(0, 0.2);

	template<typename T>
	const Vector2<T> Vector2<T>::Up(0, -0.2);

	template<typename T>
	const Vector2<T> Vector2<T>::Down(0, 0.2);

	template<typename T>
	const Vector2<T> Vector2<T>::Left(-0.2, 0);

	template<typename T>
	const Vector2<T> Vector2<T>::Right(0.2, 0);
